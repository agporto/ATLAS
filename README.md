...
* **`biocpd` 1.3.0, `codex/real-data-registration` branch** – PCA‑guided CPD atlas registration and the experimental pose-marginalized initializer. PREDICT detects the branch by its initializer API rather than changing the package version.
